...
colors = [
    ...
    (36, 60, 74), (19, 86, 89), (82, 148, 129), (147, 17, 19), 
    (27, 68, 102), (12, 70, 64), (107, 127, 153), (176, 192, 208), 
    (168, 99, 102)
]
...
for count in range(1, num_dots + 1):
    brush.dot(dot_size, random.choice(colors))  # Draw a dot with a random color
